...
import kotlinx.android.synthetic.main.activity_detail_acvitiry.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class DetailAcvitiry : BaseActivity() {

    var youtubeLink = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_acvitiry)
    ...
    fun getSpecificItem(id:String) {
        ...
        call.enqueue(object : Callback<MealResponse> {
            override fun onFailure(call: Call<MealResponse>, t: Throwable) {
                ...
                Toast.makeText(this@DetailAcvitiry, "Something went wrong", Toast.LENGTH_SHORT)
                    .show()
            }
            ...
            override fun onResponse(
                ...
                Glide.with(this@DetailAcvitiry).load(response.body()!!.mealsEntity[0].strmealthumb).into(imgItem)
